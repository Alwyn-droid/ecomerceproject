                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="product-details-large" id="ProductPhoto">
                                <img id="ProductPhotoImg" class="product-zoom" data-image-id="<?php echo $item_image; ?>" alt="12. Aliexpress dropshipping by oberlo" data-zoom-image="<?php echo $item_image; ?>" src="<?php echo $item_image; ?>">

                            </div>
                            <div id="ProductThumbs" class="product-thumbnail owl-carousel">
                                <a class="product-single__thumbnail active" href="<?php echo $item_image; ?>" data-zoom-image="<?php echo $item_image; ?>" data-image-id="6995357106246">
                                    <img src="<?php echo $item_image; ?>" alt="12. Aliexpress dropshipping by oberlo"></a>
